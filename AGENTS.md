...
- P0/P1.1/P1.3 MyBatis-Plus 和 example/springboot 商品下单示例已完成实现、全量验收并合并推送 master。最近完成的计划为 docs/superpowers/plans/2026-09-13-springboot-orders.md，实际进度与能力边界见 docs/implementation-progress.md。
